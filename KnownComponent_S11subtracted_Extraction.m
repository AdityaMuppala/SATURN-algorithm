function [ShatClean,RClean,S11_prediction,brightnessFunc] = KnownComponent_S11subtracted_Extraction(S11_subtracted, RTargettemp, thetaTarget,phiTarget,ShatMaxdB,fnpts, M, frange, fstart, fstop, k, rho_n, phi_n, z_n)
